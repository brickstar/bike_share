...
OrderAccessories.create(order_id: 1, accessory_id: 1, quantity: 5)
OrderAccessories.create(order_id: 2, accessory_id: 2, quantity: 4)
OrderAccessories.create(order_id: 3, accessory_id: 3, quantity: 3)
OrderAccessories.create(order_id: 4, accessory_id: 4, quantity: 5)
OrderAccessories.create(order_id: 7, accessory_id: 7, quantity: 2)
OrderAccessories.create(order_id: 8, accessory_id: 8, quantity: 1)
OrderAccessories.create(order_id: 9, accessory_id: 9, quantity: 2)
OrderAccessories.create(order_id: 10, accessory_id: 10, quantity: 5)
OrderAccessories.create(order_id: 11, accessory_id: 11, quantity: 3)
OrderAccessories.create(order_id: 12, accessory_id: 12, quantity: 1)
OrderAccessories.create(order_id: 13, accessory_id: 13, quantity: 4)
