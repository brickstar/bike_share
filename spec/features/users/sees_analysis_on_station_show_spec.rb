...
describe 'station show page analysis' do
  before :each do
    @station_1 = Station.create(name: 'San Jose City Hall', city: 'San Jose', dock_count: 6, installation_date: Date.strptime('8/16/2014', '%m/%d/%Y'))
    ...
    @station_6 = Station.create(name: 'Market at 28th', city: 'San Francisco', dock_count: 4, installation_date: Date.strptime('12/23/2015', '%m/%d/%Y'))
  end
